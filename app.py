# app.py – Complete RAG Chatbot (no external widget.js required)
...
print("=" * 60)
print("🚀 STARTING RAG CHATBOT (Self-Contained)")
print("=" * 60)
...
# Use a valid Groq model (check https://console.groq.com/docs/models)
...
# ===== LOAD EMBEDDING MODEL (384-dim, matches Pinecone index) =====
...
# ---- Serve the widget JavaScript directly (no external file) ----
@app.route('/widget.js')
def serve_widget():
    widget_code = """
// Chat Widget - Embedded in app.py
(function() {
    const CONFIG = {
...
def chat():
    ...
    try:
        ...
        if not context_parts:
            return jsonify({"answer": "Found low-confidence results. Please rephrase.", "sources": []})
